...
public class NRTCachingDirectory2 extends Directory {
   ...
   *  maxCachedMB */
  public NRTCachingDirectory2(Directory delegate, double maxMergeSizeMB, double maxCachedMB) {
  ...
  public synchronized void deleteFile(String name) throws IOException {
    ...
    if(cache.fileExists(name)) cache.deleteFile(name);
    if(delegate.fileExists(name)) delegate.deleteFile(name);
  }
