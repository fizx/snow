...
public class NRTCachingDirectory extends Directory {
  ...
  public void renameFile(String a, String b) {
  ...
  protected boolean doCacheWrite(String name) {
    ...
    return !name.equals("segments.gen") && cache.sizeInBytes() <= maxCachedBytes;
  }
  
  private void closeSafely(boolean suppressExceptions, IndexInput in, IndexOutput out) throws IOException {
    Throwable th = null;
